...
{
    [TestClass]
    public class HttpTestes
    {
        [TestMethod]
        public void RequestGetMethodTeste()
        {
            //var request = WebRequest.Create("http://www.example.com");
            var request = (HttpWebRequest)WebRequest.Create("http://www.example.com?nome=marcus&cpf=123");
            request.Method = "GET";
        ...
        public void RequestPostMethodTeste()
        {
            ...
            var dados = "placa=ABC1234&Ano2014&modelo=Fiesta";
